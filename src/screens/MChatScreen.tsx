...
interface MChatQuestion {
  ...
  scoring: 'yes_concern' | 'no_concern';
}

const MCHAT_QUESTIONS: MChatQuestion[] = [
  {
    id: 'q1', questionEn: 'If you point at something across the room, does your child look at it? (e.g., if you point at a toy or an animal, does your child look at the toy or animal?)',
    ...
    descriptionEn: 'Observe joint attention and following of pointing gestures.', descriptionNe: 'संयुक्त ध्यान र संकेत गर्ने इशारा अनुसरण हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q2', questionEn: 'Have you ever wondered if your child might be deaf?',
    questionNe: 'के तपाईंलाई कहिल्यै आफ्नो बच्चा बहिरो हुन सक्छ कि भन्ने लागेको छ?',
    descriptionEn: 'Check if the child responds to sounds or their name.', descriptionNe: 'बच्चाले आवाज वा आफ्नो नाममा प्रतिक्रिया दिन्छ कि भनेर जाँच गर्नुहोस्।', scoring: 'yes_concern',
  },
  {
    id: 'q3', questionEn: 'Does your child play pretend or make-believe? (e.g., pretend to drink from an empty cup, pretend to talk on a phone, or pretend to feed a doll or stuffed animal?)',
    ...
    descriptionEn: 'Look for symbolic or imaginative play behavior.', descriptionNe: 'प्रतीकात्मक वा कल्पनाशील खेलको व्यवहार हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q4', questionEn: 'Does your child like climbing on things? (e.g., furniture, playground equipment, or stairs)',
    questionNe: 'के तपाईंको बच्चालाई चीजहरूमा चढ्न मनपर्छ? (जस्तै: फर्निचर, खेल मैदानका उपकरण, वा सिढी)',
    descriptionEn: 'Observe if the child attempts to climb or explores physical challenges.', descriptionNe: 'बच्चा चढ्ने प्रयास गर्छ वा शारीरिक चुनौतीहरू अन्वेषण गर्छ कि भनेर हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q5', questionEn: 'Does your child make unusual finger movements near his or her eyes? (e.g., does your child wiggle his or her fingers close to his or her eyes?)',
    questionNe: 'के तपाईंको बच्चाले आफ्नो आँखा नजिकै औंलाहरू असामान्य रूपमा चलाउँछ? (जस्तै: आँखा नजिकै औंलाहरू हल्लाउने?)',
    descriptionEn: 'Watch for repetitive or stereotyped hand movements.', descriptionNe: 'बच्चाले हात बारम्बार घुमाउने वा दोहोर्याउने गर्छ कि भनेर हेर्नुहोस्।', scoring: 'yes_concern',
  },
  {
    id: 'q6', questionEn: 'Does your child point with one finger to ask for something or to get help? (e.g., pointing to a cracker or a toy that is out of reach)',
    ...
    descriptionEn: 'Observe if the child uses pointing to communicate needs or share interest.', descriptionNe: 'बच्चा आवश्यकता संचार गर्न वा रुचि साझा गर्न संकेत गर्छ कि भनेर हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q7', questionEn: 'Does your child point with one finger to show you something interesting? (e.g., pointing to an airplane in the sky or a big truck in the road)',
    ...
    descriptionEn: 'Look for joint attention and sharing of interest.', descriptionNe: 'बच्चाले तपाईंसँग ध्यान दिन्छ र रुचि देखाउँछ कि हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q8', questionEn: 'Is your child interested in other children? (e.g., does your child watch other children, smile at them, or go to them?)',
    ...
    descriptionEn: 'Look for eye contact, smiling, or attempts to interact with other children.', descriptionNe: 'अन्य बच्चाहरूसँग आँखाको सम्पर्क, मुस्कुराउने, वा अन्तरक्रिया गर्ने प्रयास हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q9', questionEn: 'Does your child show you things by bringing them to you or holding them up for you to see — not to get help, but just to share? (e.g., showing you a flower, a stuffed animal, or a toy truck)',
    ...
    descriptionEn: 'Look for sharing of objects and joint attention.', descriptionNe: 'वस्तु साझा गरिएको र संयुक्त ध्यान हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q10', questionEn: 'Does your child respond when you call his or her name? (e.g., does he or she look up, talk or babble, or stop what he or she is doing when you call his or her name?)',
    ...
    descriptionEn: 'Watch for name recognition and response.', descriptionNe: 'नाम पहिचान र प्रतिक्रिया हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q11', questionEn: 'When you smile at your child, does he or she smile back at you?',
    questionNe: 'जब तपाईं आफ्नो बच्चालाई हेरेर मुस्कुराउनुहुन्छ, के उसले पनि तपाईंलाई हेरेर मुस्कुराउँछ?',
    descriptionEn: 'Look for social reciprocity in smiling.', descriptionNe: 'मुस्कानमा सामाजिक आपसी प्रतिक्रिया हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q12', questionEn: 'Does your child get upset by everyday noises? (e.g., does your child scream or cry to noise such as a vacuum cleaner or loud music?)',
    ...
    descriptionEn: 'Watch for unusual reactions to sounds.', descriptionNe: 'आवाजमा असामान्य प्रतिक्रिया हेर्नुहोस्।', scoring: 'yes_concern',
  },
  {
    id: 'q13', questionEn: 'Does your child walk?', questionNe: 'के तपाईंको बच्चा हिँड्छ?',
    descriptionEn: 'Observe gross motor development.', descriptionNe: 'सामान्य शारीरिक विकास हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q14', questionEn: 'Does your child look you in the eye when you are talking to him or her, playing with him or her, or dressing him or her?',
    questionNe: 'के तपाईंको बच्चाले तपाईंसँग कुरा गर्दा, खेल्दा, वा लुगा लगाइदिँदा तपाईंको आँखामा हेर्छ?',
    descriptionEn: 'Observe sustained eye contact during interaction.', descriptionNe: 'अन्तरक्रियाको समयमा स्थिर आँखाको सम्पर्क हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q15', questionEn: 'Does your child try to copy what you do? (e.g., wave bye-bye, clap, or make a funny noise when you do)',
    ...
    descriptionEn: 'Observe imitation of facial expressions or actions.', descriptionNe: 'अनुहारको अभिव्यक्ति वा कार्यहरूको नक्कल हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q16', questionEn: 'If you turn your head to look at something, does your child look around to see what you are looking at?',
    ...
    descriptionEn: 'Observe joint attention and gaze following.', descriptionNe: 'संयुक्त ध्यान र दृष्टि अनुसरण हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q17', questionEn: 'Does your child try to get you to watch him or her? (e.g., does your child look at you for praise, or say "look" or "watch me"?)',
    ...
    descriptionEn: 'Observe if the child seeks social attention or praise.', descriptionNe: 'बच्चाले सामाजिक ध्यान वा प्रशंसा खोज्छ कि भनेर हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q18', questionEn: 'Does your child understand when you tell him or her to do something? (e.g., if you don\'t point, can your child understand "put the book on the chair" or "bring me the blanket"?)',
    ...
    descriptionEn: 'Observe receptive language and comprehension.', descriptionNe: 'बच्चाको कुरा बुझ्ने क्षमता र समझ हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q19', questionEn: 'If something new happens, does your child look at your face to see how you feel about it? (e.g., if he or she hears a strange or funny noise, or sees a new toy, will he or she look at your face?)',
    questionNe: 'यदि केही नयाँ कुरा भयो भने, के तपाईंको बच्चाले तपाईंलाई कस्तो लाग्यो भनेर तपाईंको अनुहारमा हेर्छ?',
    descriptionEn: 'Observe social referencing behavior.', descriptionNe: 'बच्चाले अरुको प्रतिक्रिया हेरेर व्यवहार गर्छ कि हेर्नुहोस्।', scoring: 'no_concern',
  },
  {
    id: 'q20', questionEn: 'Does your child enjoy movement activities? (e.g., being swung or bounced on your knee)',
    questionNe: 'के तपाईंको बच्चालाई हलचल हुने गतिविधिहरू मनपर्छ? (जस्तै: पिङ खेलेको जस्तो हल्लाउने वा घुँडामा उफार्ने?)',
    descriptionEn: 'Watch if the child laughs and shows enjoyment during physical play.', descriptionNe: 'बच्चाले शारीरिक खेल खेल्दा हाँस्छ र रमाउँछ कि भनेर हेर्नुहोस्।', scoring: 'no_concern',
  },
];
  ...
  const calculateScore = () => {
    ...
    MCHAT_QUESTIONS.forEach(q => {
      ...
      if (response !== undefined) {
        if (q.scoring === 'yes_concern') { if (response === true) { totalScore += 1; concernList.push(q.id); } }
        ...
        {!isAppropriateAge ? (
          <View style={styles.centeredContent}>
            <View style={styles.warningBoxLarge}>
              ...
              <Text style={styles.warningTitleNe}>{isNe ? 'उमेर मान्य छैन' : 'उमेर मान्य छैन'}</Text>
              ...
              return (
                <View key={q.id} style={[styles.questionCard, showHighlights && styles.concernCard]}>
                  ...
                  <View style={styles.optionsRow}>
                    <TouchableOpacity
                      style={[styles.optionBtn, responses[q.id] === true && styles.optionYes, showHighlights && responses[q.id] === true && styles.optionConcern]}
                      onPress={() => !isReviewMode && setResponses(prev => ({ ...prev, [q.id]: true }))} disabled={isReviewMode}
                    >
                      <Text style={[styles.optionText, responses[q.id] === true && styles.optionTextActive]}>{isNe ? 'हो' : 'Yes'}</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={[styles.optionBtn, responses[q.id] === false && styles.optionNo, showHighlights && responses[q.id] === false && styles.optionConcern]}
                      onPress={() => !isReviewMode && setResponses(prev => ({ ...prev, [q.id]: false }))} disabled={isReviewMode}
                    >
                      <Text style={[styles.optionText, responses[q.id] === false && styles.optionTextActive]}>{isNe ? 'होइन' : 'No'}</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              );
        ...
        <Modal visible={showResultModal} transparent animationType="fade">
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              {score > 0 && (
                <Text style={styles.reviewPrompt}>{isNe ? 'चिन्ताका विषयहरू हेर्नको लागि तल स्क्रोल गर्नुहोस्।' : 'Scroll down to review the areas of concern.'}</Text>
              )}
