...
export const translations = {
  en: {
    ...
    // Help bubbles
    helpWAZTitle: 'What is WAZ?',
    helpWAZBody: 'Weight-for-Age Z-score compares your child\'s weight to WHO standards for their age. A score between -2 and +2 is considered normal. Values outside this range may indicate undernutrition or overnutrition.',
    helpMCHATTitle: 'About M-CHAT-R/F',
    helpMCHATBody: 'The Modified Checklist for Autism in Toddlers screens for autism risk. It asks 20 yes/no questions about your child\'s behavior. This is a screening tool, not a diagnosis. High scores should be followed up with professional evaluation.',
    helpBCGTitle: 'BCG Vaccine',
    helpBCGBody: 'BCG protects against tuberculosis (TB). It is given at birth as a single dose in the upper arm. A small scar at the injection site is normal and indicates the vaccine worked.',
    helpOPVTitle: 'OPV Vaccine',
    helpOPVBody: 'Oral Polio Vaccine protects against polio, a disease that can cause paralysis. It is given as drops in the mouth at 6, 10, and 14 weeks of age.',
    helpPCVTitle: 'PCV Vaccine',
    helpPCVBody: 'Pneumococcal Conjugate Vaccine protects against pneumonia, meningitis, and ear infections caused by pneumococcal bacteria. Given in 3 doses at 6, 10 weeks, and 9 months.',
    helpIPVTitle: 'IPV Vaccine',
    helpIPVBody: 'Inactivated Polio Vaccine is an injectable polio vaccine given alongside OPV for stronger protection. Doses are given at 14 weeks and 9 months.',
    helpJETitle: 'JE Vaccine',
    helpJEVBody: 'Japanese Encephalitis vaccine protects against brain inflammation caused by the JE virus, spread by mosquitoes. Given as a single dose at 12 months.',
    helpTCVTitle: 'TCV Vaccine',
    helpTCVBody: 'Typhoid Conjugate Vaccine protects against typhoid fever, a bacterial infection from contaminated food or water. Given at 15 months as a single dose.',
  ...
  ne: {
    ...
    // Help bubbles
    helpWAZTitle: 'WAZ के हो?',
    helpWAZBody: 'यो उमेर अनुसारको तौल सूचकांक हो, जसले WHO मापदण्ड अनुसार बच्चाको तौल तुलना गर्छ। -२ देखि +२ को बीच सामान्य मानिन्छ। यो भन्दा बाहिर कुपोषण वा अत्यधिक तौलको संकेत हुन सक्छ।',
    helpMCHATTitle: 'M-CHAT बारे',
    helpMCHATBody: 'यो अटिजम जाँच्ने उपकरण हो। यसमा २० प्रश्न हुन्छन्। यो स्क्रिनिङ मात्र हो, निदान होइन। उच्च अंक आएमा विशेषज्ञसँग परामर्श लिनुपर्छ।',
    helpBCGTitle: 'बीसीजी खोप',
    helpBCGBody: 'बीसीजीले क्षयरोग (TB) बाट बचाउँछ। यो जन्मने बित्तिकै पाखुरामा एक पटक लगाइन्छ। खोप लगाएको ठाउँमा सानो दाग बन्नु सामान्य हो र यसले खोप काम गरेको देखाउँछ।',
    helpOPVTitle: 'ओपीभी खोप',
    helpOPVBody: 'मुखबाट दिइने पोलियो खोपले पक्षाघात गराउन सक्ने पोलियो रोगबाट बचाउँछ। यो ६, १० र १४ हप्तामा मुखमा थोपाको रूपमा दिइन्छ।',
    helpPCVTitle: 'पीसीभी खोप',
    helpPCVBody: 'यो खोपले निमोनिया, मेनिन्जाइटिस र कानको संक्रमणबाट बचाउँछ। यो ६, १० हप्ता र ९ महिनामा गरी तीन खुराक दिइन्छ।',
    helpIPVTitle: 'आईपीभी खोप',
    helpIPVBody: 'यो सुईद्वारा दिइने पोलियो खोप हो, जो ओपीभीसँगै बलियो सुरक्षाको लागि दिइन्छ। १४ हप्ता र ९ महिनामा खुराक दिइन्छ।',
    helpJETitle: 'जेई खोप',
    helpJEVBody: 'यो खोपले लामखुट्टेले सार्ने दिमागी ज्वरो (जापानिज इन्सेफलाइटिस) बाट बचाउँछ। १२ महिनामा एउटा खुराक दिइन्छ।',
    helpTCVTitle: 'टाइफाइड खोप',
    helpTCVBody: 'यो खोपले दूषित खाना वा पानीबाट हुने टाइफाइड ज्वरोबाट बचाउँछ। १५ महिनामा एक पटक दिइन्छ।',
    ...
    // About / Author
    about: 'परिचय',
    aboutAuthor: 'विकासकर्ताको परिचय',
