...
- **Residual (deferred)**: Hermes V1 `250829098.0.10` memory regression. Fix requires an Expo SDK 57 / React Native 0.86.2 upgrade — a breaking change to the working Android build. **Not performed**; Android runtime concern, not a web blocker. Decision documented for the owner.
